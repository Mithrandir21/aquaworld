 ...
 */
public class WidgetFish extends ImageWidget implements WidgetTransferable
{
	// The object that the widget represents.
	private FishObject object = null;
	 ...
	 * @param objImg
	 */
	public WidgetFish(Scene scene, FishObject obj, Image objImg)
	{
		super(scene, objImg);
		object = obj;
	 ...
	 *            the object to set
	 */
	public void setObject(FishObject object)
	{
		this.object = object;
	}
	...
	public WidgetFish getTransferData(DataFlavor flavor)
	...
	private DataFlavor[] setFlavor()
	{
		...
		if ( flavors[0] == null )
		{
			flavors[0] = new DataFlavor(WidgetFish.class, "Widget Fish");
		}
