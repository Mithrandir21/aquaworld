 ...
 */
public class WidgetCoral extends ImageWidget implements WidgetTransferable
{
	// The object that the widget represents.
	private CoralObject object = null;
	 ...
	 * @param objImg
	 */
	public WidgetCoral(Scene scene, CoralObject obj, Image objImg)
	{
		super(scene, objImg);
		this.object = obj;
	...
	/*
	 * (non-Javadoc)
	 * @see widgets.WidgetTransferable#getImageDimension()
	 */
	 ...
	 *            the object to set
	 */
	public void setObject(CoralObject object)
	{
		this.object = object;
	}
	...
	public WidgetCoral getTransferData(DataFlavor flavor)
	...
	private DataFlavor[] setFlavor()
	{
		...
		if ( flavors[0] == null )
		{
			flavors[0] = new DataFlavor(WidgetCoral.class, "Widget Coral");
		}
