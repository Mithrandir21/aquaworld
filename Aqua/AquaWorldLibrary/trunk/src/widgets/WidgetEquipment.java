 ...
 */
public class WidgetEquipment extends ImageWidget implements WidgetTransferable
{
	// The object that the widget represents.
	private EquipmentObject object = null;
	 ...
	 * @param objImg
	 */
	public WidgetEquipment(Scene scene, EquipmentObject obj, Image objImg)
	{
		super(scene, objImg);
		this.object = obj;
	 ...
	 * @return the object
	 */
	public EquipmentObject getObject()
	{
		return object;
	}
	 ...
	 *            the object to set
	 */
	public void setObject(EquipmentObject object)
	{
		this.object = object;
	}
	...
	public WidgetEquipment getTransferData(DataFlavor flavor)
	...
	private DataFlavor[] setFlavor()
	{
		...
		if ( flavors[0] == null )
		{
			flavors[0] = new DataFlavor(WidgetEquipment.class,
					"Widget Equipment");
		}
