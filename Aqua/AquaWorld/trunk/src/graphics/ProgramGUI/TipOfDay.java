...
public class TipOfDay extends JFrame implements ActionListener
{
	...
	public TipOfDay()
	{
		super(AquaWorld.texts.getString("totdTitle"));
	...
	public JPanel getButtons()
	{
		...
		JCheckBox box = new JCheckBox(AquaWorld.texts
				.getString("totdShowTipOnStartup"));
		box.addActionListener(this);
		box.setActionCommand("showTips");


		JButton next = new JButton(AquaWorld.texts
		...
		JButton close = new JButton(AquaWorld.texts.getString("closeButton"));
