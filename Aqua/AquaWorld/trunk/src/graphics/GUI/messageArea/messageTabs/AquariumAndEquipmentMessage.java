 ...
 */
public class AquariumAndEquipmentMessage extends JPanel implements
		MessageInterface
{
	 ...
	 * TODO - Description NEEDED!
	 */
	public AquariumAndEquipmentMessage()
	{
	 ...
	 * TODO - Description NEEDED!
	 */
	public AquariumAndEquipmentMessage(Aquarium aqua)
	{
		processInfo(aqua);
	...
	public void processInfo(Aquarium aqua)
	{
		...
		data = MessageProcessing.processAquariumAndEquipmentData(aqua
				.getContent());
